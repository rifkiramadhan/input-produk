        ...
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <i class="fa fa-user"></i> <?php echo $_SESSION['membername'];?>
            </a>
                ...
                foreach ($hasil as $key => $data) {
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <button type="button" class="btn btn-warning ubah" ><i class="fa fa-eye" aria-hidden="true"></i> Lihat</button>
                            </td>
                        </tr>
                    </tbody>
                <?php
            ...
            <form action="" id="form">
                ...
                <div class="modal-content">
                    <div class="modal-header bg bg-dark text-light">
                        <h5 class="modal-title" id="ModalLabel">Lihat Produk</h5>
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <input type="text" name="merek" placeholder="Masukkan merek" class="form-control" id="" aria-describedby="" disabled>
                        </div>
                        <div class="form-group">
                            <label for="warna">Warna:</label>
                            <input type="text" name="warna" placeholder="Masukkan warna" class="form-control" id="" disabled>
                        </div>
                        <div class="form-group">
                            <label for="stok">Stok:</label>
                            <input type="number" name="stok" placeholder="Masukkan jumlah stok tersedia" class="form-control" id="" min="0" require>
                        </div>
                        <div class="form-group">
                            <label for="satuan">Satuan:</label>
                            <select name="satuan" class="form-control" id="exampleFormControlSelect1" disabled>
                        ...
                        <div class="form-group">
                            ...
                            <input type="harga" name="harga" placeholder="Masukkan harga hanya angka" class="form-control" id="" min="0" disabled>
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-dismiss="modal" id="close"><i class="fa fa-window-close"></i> Batal Beli</button>
                        <button type="button" class="btn btn-primary"><i class="fa fa-shopping-basket"></i> Beli Sekarang</button>
                    </div>
                </div>
            </form>
        </div>
